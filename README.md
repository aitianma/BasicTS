...
| 📊Baseline    | 📝Title                                                                                                  | 📄Paper                                                | 💻Code                                                                        | 🏛Venue    | 🎯Task |
| :------------ | :------------------------------------------------------------------------------------------------------- | :----------------------------------------------------- | :---------------------------------------------------------------------------- | :--------- | :----- |
| MMFNet         | mmfnet: multi-scale frequency masking neural network for time series forecasting           | [Link](https://users.cs.fiu.edu/~msha/publications/sac26.pdf)                  | [Link](https://github.com/aitianma/MMFNet)                                        | SAC'26 | LTSF   |
